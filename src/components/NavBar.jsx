      ...
      <nav className="navbar" id='home'>
            ...
            <div class="nav-links" ref={hamref}>
                <ul>
                    ...
                    <button type="button" class="text-white bg-[#050708]  focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-1 text-center flex items-center mr-1.5 mb-2 signin-button">
